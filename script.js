...
const songs = ['Dosti','Etthara Jenda','Janani','Komuram Bheemudo','Naatu Naatu','Raamam Raaghavam'];
let songIndex = 0;
...
function changeVolume(event){
    ...
    video.volume = volume;
    // Change volume icon values depending upon volume
